...
const RELEASES: Release[] = [
  ...
  },
  {
    ...
    changes: [
      { kind: "feature", text: "Hệ thống Auth Supabase với role ADMIN / REFEREE / PLAYER" },
      ...
      { kind: "feature", text: "Admin panel tạo referee account và phân quyền player" },
  ...
  },
  {
    ...
    changes: [
      ...
      { kind: "improvement", text: "Composition root wires Supabase + HTTP gateway" },
